...
import GameReset from "./components/NavBar/GameReset";
import GuessedIncorrectly from "./components/NavBar/GuessedIncorrectly";
import GuessedCorrectly from "./components/NavBar/GuessedCorrectly";
...
// }
    ...
    renderImage = () => {
      if(this.state.currentPage ==="Game Reset") {
        return <Game Reset />;
      }
    }
  ...
  render() {
    return (
      <div>
          currentNavBar={this.state.currentNavBar}
      ...
      <image alt={imageData[0].name} src={imageData[0].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[1].name} src={imageData[1].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[2].name} src={imageData[2].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[3].name} src={imageData[3].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[4].name} src={imageData[4].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[5].name} src={imageData[5].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[6].name} src={imageData[6].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[7].name} src={imageData[7].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[8].name} src={imageData[8].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[9].name} src={imageData[9].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[10].name} src={imageData[10].image} onClick={this.handleIncrement}>
      </image>
      <image alt={imageData[11].name} src={imageData[11].image} onClick={this.handleIncrement}>
      </image>
